...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        def openFile():
            filepath = filedialog.askopenfilename(initialdir="D:\\Faaclty\\level 3\\selcted-1\\selected-1 project")
            file = open(filepath, 'r')
            print(filepath)
            self.Label8.configure(text=get_result("D:\\Faaclty\\level 3\\selcted-1\\selected-1 project\\ANN Image\\model.h5",filepath))
